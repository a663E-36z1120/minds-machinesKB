...
---
**1 .  Forward Pass**  
For each layer $\ell=1,\dots,L$ of feed-forward [[artificial neural network]](e.g. multi-layer [[perceptron]]s (MLP)), with weights $W$, bias $b$, activation function $\phi$, hidden state (activity of previous layer) $h$, output $z$:
$$
\begin{aligned}
